...
export async function getSpecs(endpoint: string) {
    const url = `${endpoint}/lavanet/lava/spec/show_all_chains`
    return get(url)
}
export async function getProviders(endpoint: string, chainId: string) {
