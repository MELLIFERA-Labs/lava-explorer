...
import { BroadcastMode, type Coin, type CoinMetadata } from '../../utils/type';
import { WalletName, readWallet } from '@/widget-lib/wallet/Wallet';
import { UniClient } from '@/widget-lib/wallet/UniClient';
...
async function sendTx() {
    try {
        ...
        const tx = {
            ...
            //       toProvider: 'lava@139eygetxxme2rvg25yrvctg4l22yn7an37s0zl',
            //       fromChainID: "*",
            //       toChainID: "LAV1",
            //       amount: coin(1, 'ulava'),
            //     }
...
<template>
    <div class="text-gray-600">
        ...
        <label :for="type" class="modal  cursor-pointer">
            <label class="modal-box overflow-auto bg-graylight relative p-5 overflow-y-visible" :class="{ '!w-11/12 !max-w-5xl': String(type).startsWith('wasm') }" for="">
